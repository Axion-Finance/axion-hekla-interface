...
import { LIQ_STATS_API_URL, getStatsAPIUrl } from "config/backend";
...
// async function getChartPricesFromPyth(chainId, symbol, period) {
//   if (["WBTC", "WETH", "WETH"].includes(symbol)) {
