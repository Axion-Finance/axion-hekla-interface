    ...
    <>
      <div className="App">
        <div className="App-content">
          ...
          />
          {/* START App gradient dot background  */}
          {/* <div className="app-bg-orange" style={{ top: "-100px", left: "-100px" }} />
          <div className="app-bg-brown" style={{ top: "640px", right: "-100px" }} />
          <div className="app-bg-orange" style={{ top: "1300px", left: "-100px" }} />
          <div className="app-bg-brown" style={{ top: "1800px", right: "-100px" }} />
          <div className="app-bg-orange" style={{ top: "2100px", left: "-100px" }} /> */}
          {/* END App gradient dot background */}
          {isHome && (
            <Switch>
              <Route exact path="/">
      ...
      >
        <div className="App-settings-row">
          ...
          <div className="App-slippage-tolerance-input-container">
            <input
              type="number"
              className="App-slippage-tolerance-input text-input"
              min="0"
