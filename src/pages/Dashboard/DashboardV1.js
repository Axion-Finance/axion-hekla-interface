...
export default function DashboardV1() {
  ...
  const { data: pairInfo, mutate: updatePairInfo } = useSWR(
    ...
    {
      fetcher: contractFetcher(library, Reader, [[gmtAddress, usdfAddress, xgmtAddress, usdfAddress]]),
    }
  );

  const { data: usdgSupply, mutate: updateUsdgSupply } = useSWR(
    ["Dashboard:usdgSupply", chainId, usdfAddress, "totalSupply"],
    {
            ...
            <div className="Dashboard-token-title App-card-title">
              ...
              <div className="Dashboard-token-title-options">
                <img
                  ...
                  onClick={() =>
                    addToken({
                      address: "0x3Ec4c26e47b4a6CFcd255c61cd3dEF98b0A3c8e5",
                      symbol: "USDG",
                      info: {
                        decimals: 18,
