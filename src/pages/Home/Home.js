...
export default function Home({ showRedirectModal, redirectPopupTimestamp }) {
  ...
  //   answer: "The GLP token represents the liquidity users provide to the Axion platform for Swaps and Margin Trading.<br><br>To provide liquidity to GLP you <a href='https://testnet.axion.finance/liquidity' target='_blank'>trade</a> your crypto asset BTC, ETH, LINK, UNI, USDC, USDT, MIM, or FRAX to the liquidity pool, in exchange, you gain exposure to a diversified index of tokens while earning 50% of the platform trading fees and esLIQ."
  // }, {
  //   id: 4,
