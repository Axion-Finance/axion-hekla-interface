...
import { approvePlugin, cancelMultipleOrders, useMinExecutionFee } from "domain/legacy";
import {
...
export const Exchange = forwardRef((props, ref) => {
  ...
  // console.log("Native Address : ", nativeTokenAddress);
  ...
  useEffect(() => {
    ...
    let currentTokenPriceStr = formatAmount(
      ...
      USD_DECIMALS,
      fromToken.displayDecimals ?? toToken.displayDecimals ?? 2,
      true
    );
