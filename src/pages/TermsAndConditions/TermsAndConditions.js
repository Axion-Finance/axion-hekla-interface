      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">Axion</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to Axion.io ("we," "us," or "our"), the informational resource for Axion Protocol, as defined
                below.
              </p>
              <p className="body-text">
                Axion.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the Axion Protocol (the "Axion Protocol," "Protocol," or "Axion DApp"). Axion.io is not
                an available access point to the Axion Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access Axion.io ("the Site") and app.Axion.io ("the Interface"). Please
                do not use the Site or Interface if you disagree with any of these Terms.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">1. USE OF THE SITE AND THE INTERFACE</h3>
              <p className="body-text">The Axion.io site is for informational purposes only.</p>
              <p className="body-text">
                Axion.io is not part of any transaction on the blockchain networks underlying the Axion Protocol; we do
                ...
                receive any crypto assets. You understand that when you interact with any Axion Protocol smart
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over Axion.io or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that Axion.io or any of its suppliers or contractors may undertake from
                        time to time; (c) causes beyond Axion.io's control or that Axion.io could not reasonably
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with Axion.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. Axion.io does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. Axion.io does not receive fees for any blockchain transactions or using the Site or the Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. Axion.io own all rights, names, logos, and other marks used on the Site and the Interface,
                    including, without limitation, any copyrights in and to any content, code, data, or other materials
                    that you may access or use on or through the Site or the Interface; however, the code for the Axion
                    Protocol and the Interface (app.Axion.io) deployed on IPFS is open-sourced. Except as expressly set
                ...
                <li>
                  <p className="body-text">
                    4.2. Axion.io may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that Axion.io is free to use or
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. Axion.io reserve the right, at our sole discretion, from time to time and with or without prior
                    ...
                    own its code. Axion.io will not be liable for any losses suffered by you resulting from any
                ...
                <li>
                  <p className="body-text">
                    ...
                    always be at https://axion.markets/#/terms-and-conditions. All modifications will be effective when
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. Axion.io does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That Axion.io is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither Axion.io nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. Axion.io is not responsible for the content of any third party, including, but not limited to,
                    information, materials, products, or services that Axion.io does not own or control. In addition,
                    third parties may offer promotions related to your access and use of the Interface. Axion.io does
                    ...
                    You expressly relieve Axion.io of all liability arising from using such resources or participating
                    in such promotions.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that Axion.io will have no responsibility or liability for the
                    risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against Axion.io, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of Axion.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including Axion.io's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                Axion.io is an informational site for the Axion Protocol. Axion.io does not operate an exchange platform
              ...
              <p className="body-text">
                You understand that Axion.io is not registered or licensed by any regulatory agency or authority. No
                such agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. Axion.io
            ...
            <div className="section">
              ...
              <p className="body-text">
                In no event shall Axion.io, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of Axion.io, whether under contract, tort
                ...
                or any limited remedy hereunder nor is Axion.io in any way responsible for the execution or settlement
                of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall Axion.io's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless Axion.io, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                Axion.io will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to Axion.io on any of our official channels. The notice must (a) describe the nature
                and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar
                in form to that described above. If you and Axion.io cannot reach an agreement to resolve the claim
                within sixty (60) days of your email, then you and Axion.io agree to resolve the potential dispute
              ...
              <p className="body-text">
                ...
                Axion.io will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of Axion.io set forth in these Terms is in addition to, and not in lieu
                    of, any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of Axion.io in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. Axion.io will have no responsibility or liability for any failure or delay in performance of
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and Axion.io and supersede all prior and
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                Axion.io on any of our official channels.
              </p>
            </div>
          </div>
        </div>
