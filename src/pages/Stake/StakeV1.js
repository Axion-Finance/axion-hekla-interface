...
export default function StakeV1() {
  ...
  const usdfAddress = getContract(CHAIN_ID, "USDG");
  ...
  const yieldTokens = [usdfAddress, xgmtAddress];
  ...
  const buyXgmtUrl = `https://exchange.pancakeswap.markets/#/swap?outputCurrency=${xgmtAddress}&inputCurrency=${usdfAddress}`;
  const buyGmtUrl = `https://exchange.pancakeswap.markets/#/swap?outputCurrency=${gmtAddress}&inputCurrency=${usdfAddress}`;

  const addGmtUsdgLpUrl = `https://exchange.pancakeswap.markets/#/add/${gmtAddress}/${usdfAddress}`;
  const addXgmtUsdgLpUrl = `https://exchange.pancakeswap.markets/#/add/${xgmtAddress}/${usdfAddress}`;

  const buyAutoUrl = `https://exchange.pancakeswap.markets/#/swap?outputCurrency=${autoAddress}&inputCurrency=${nativeTokenAddress}`;
  const addAutoUsdgLpUrl = `https://exchange.pancakeswap.markets/#/add/${autoAddress}/${usdfAddress}`;
  ...
  return (
    <div className="Stake Page page-layout">
      ...
      <div className="App-warning Stake-warning">
        <Trans>
          The <Link to="/migrate">Axion migration</Link> is in progress, please migrate your GMT, xGMT, GMT-USDG and
          xGMT-USDG tokens.
          <br />
      ...
      <div className="Stake-cards">
        <div className="App-card primary">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              <Link className="default-btn App-card-option" to="/trade">
                Get USDG
              </Link>
              {active && (
                <button
                  className="default-btn App-card-option"
                  onClick={() => claim(usdfAddress, processedData.usdgRewards)}
                >
                  <Trans>Claim</Trans>
                </button>
              )}
        ...
        <div className="App-card">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              <ExternalLink className="default-btn App-card-option" href={buyXgmtUrl}>
                Get xGMT
              </ExternalLink>
              {active && (
                <button
        ...
        <div className="App-card">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              <ExternalLink className="default-btn App-card-option" href={buyGmtUrl}>
                Get GMT
              </ExternalLink>
              <ExternalLink className="default-btn App-card-option" href={addGmtUsdgLpUrl}>
                <Trans>Create</Trans>
              </ExternalLink>
              {active && (
                <button className="default-btn App-card-option" onClick={() => showUnstakeGmtUsdgModal()}>
                  <Trans>Unstake</Trans>
                </button>
              )}
              {active && (
        ...
        <div className="App-card">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              ...
              <ExternalLink className="default-btn App-card-option" href={addXgmtUsdgLpUrl}>
                <Trans>Create</Trans>
              </ExternalLink>
              {active && (
                <button className="default-btn App-card-option" onClick={() => showUnstakeXgmtUsdgModal()}>
                  <Trans>Unstake</Trans>
                </button>
              )}
              {active && (
        ...
        <div className="App-card">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              <ExternalLink className="default-btn App-card-option" href={buyAutoUrl}>
                Get AUTO
              </ExternalLink>
              <ExternalLink className="default-btn App-card-option" href={addAutoUsdgLpUrl}>
                <Trans>Create</Trans>
              </ExternalLink>
              {active && (
                <button className="default-btn App-card-option" onClick={() => showStakeAutoUsdgModal()}>
                  <Trans>Stake</Trans>
                </button>
              )}
              {active && (
                <button className="default-btn App-card-option" onClick={() => showUnstakeAutoUsdgModal()}>
                  <Trans>Unstake</Trans>
                </button>
              )}
              {active && (
