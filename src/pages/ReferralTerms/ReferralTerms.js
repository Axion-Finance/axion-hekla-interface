          ...
          <div className="content">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                https://testnet.axion.finance/referral-terms. All modifications will be effective when they are posted.
                By using the Referral Program after those revisions become effective, you agree to be bound by the
                revised Terms.
              </p>
            </div>
            <div className="section">
