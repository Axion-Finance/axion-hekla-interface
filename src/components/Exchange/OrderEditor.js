...
import { updateDecreaseOrder, updateIncreaseOrder, updateSwapOrder } from "domain/legacy";
    ...
    return (
      ...
      >
        ...
        <div className="Exchange-swap-button-container">
          <button
            className="default-btn Exchange-swap-button Exchange-list-modal-button"
