                ...
                <div key={position.key} className="App-card">
                        ...
                        {positionOrders.map((order) => {
                          const orderText = () => (
                            <>
                              ...
                              {formatAmount(order.triggerPrice, 30, position?.indexToken?.displayDecimals || 2, true)}:
                  ...
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>
                        $
                        {formatAmount(liquidationPrice, USD_DECIMALS, position?.indexToken?.displayDecimals || 2, true)}
                      </div>
                    </div>
                  </div>
