...
import {
  /*ARBITRUM, AVALANCHE,*/ IS_NETWORK_DISABLED,
  getChainName,
  getConstant,
  isSupportedChain,
} from "config/chains";
...
export default function SwapBox(props) {
  ...
  //   if (chainId === ARBITRUM) {
  //     return "https://www.liq.house/arbitrum/leaderboard";
  //   }
  //   if (chainId === AVALANCHE) {
  //     return "https://www.liq.house/avalanche/leaderboard";
  //   }
  //   return "https://www.liq.house";
  // };
  ...
  // const data = getContract(chainId, "NATIVE_TOKEN");
  ...
  // console.log("collateralTokenAddress : ", collateralTokenAddress, indexTokenAddress);
  ...
  const increasePosition = async () => {
    ...
    callContract(chainId, contract, method, params, {
      ...
      hideSuccessMsg: false, //chainId === ARBITRUM,
    })
      .then(async () => {
        setIsConfirming(false);
  ...
  const priceFormatDecimal = fromToken.displayDecimals ?? toToken.displayDecimals ?? 2;
  return (
                ...
                <div className="muted">
                  {fromUsdMin && (
                    <div className="Exchange-swap-usd">
                      <Trans>Pay: {formatAmount(fromUsdMin, USD_DECIMALS, priceFormatDecimal, true)} USD</Trans>
                    </div>
                  )}
                  {!fromUsdMin && t`Pay`}
                </div>
            ...
            <div className="Exchange-swap-section">
              <div className="Exchange-swap-section-top">
                <div className="muted">
                  {toUsdMax && (
                    <div className="Exchange-swap-usd">
                      {getToLabel()}: {formatAmount(toUsdMax, USD_DECIMALS, priceFormatDecimal, true)} USD
                    </div>
                  )}
                  {!toUsdMax && getToLabel()}
                </div>
                ...
                {(isLong || isShort) && hasLeverageOption && (
                  <div className="muted align-right">
                    <Trans>Leverage</Trans>: {parseFloat(leverageOption).toFixed(priceFormatDecimal)}x
                  </div>
                )}
              </div>
              <div className="Exchange-swap-section-bottom">
          ...
          <div className="Exchange-swap-section">
            <div className="Exchange-swap-section-top">
              ...
              <div
                className="muted align-right clickable"
                onClick={() => {
                  setTriggerPriceValue(formatAmountFree(entryMarkPrice, USD_DECIMALS, priceFormatDecimal));
                }}
              >
                <Trans>Mark: {formatAmount(entryMarkPrice, USD_DECIMALS, priceFormatDecimal, true)}</Trans>
              </div>
            </div>
            <div className="Exchange-swap-section-bottom">
              <div className="Exchange-swap-input-container">
              ...
              <div>
                ...
                {fees && (
                  <div>
                    ...
                    {fromToken.symbol}: ${formatAmount(feesUsd, USD_DECIMALS, priceFormatDecimal, true)})
                  </div>
                )}
              </div>
            </ExchangeInfoRow>
          ...
          <div className="Exchange-leverage-box">
              ...
              <div className="align-right">
                {hasExistingPosition && toAmount && toAmount.gt(0) && (
                  <div className="inline-block muted">
                    {formatAmount(existingPosition.leverage, 4, priceFormatDecimal)}x
                    <BsArrowRight className="transition-arrow" />
                  </div>
                )}
                {toAmount && leverage && leverage.gt(0) && `${formatAmount(leverage, 4, priceFormatDecimal)}x`}
            ...
            <div className="Exchange-info-row">
              ...
              <div className="align-right">
                {hasExistingPosition && toAmount && toAmount.gt(0) && (
                  <div className="inline-block muted">
                    ${formatAmount(existingPosition.averagePrice, USD_DECIMALS, priceFormatDecimal, true)}
                    <BsArrowRight className="transition-arrow" />
                  </div>
                )}
                {nextAveragePrice && `$${formatAmount(nextAveragePrice, USD_DECIMALS, priceFormatDecimal, true)}`}
                {!nextAveragePrice && `-`}
              </div>
            </div>
            <div className="Exchange-info-row">
              ...
              <div className="align-right">
                {hasExistingPosition && toAmount && toAmount.gt(0) && (
                  <div className="inline-block muted">
                    ${formatAmount(existingLiquidationPrice, USD_DECIMALS, priceFormatDecimal, true)}
                    <BsArrowRight className="transition-arrow" />
                  </div>
                )}
                {toAmount &&
                  displayLiquidationPrice &&
                  `$${formatAmount(displayLiquidationPrice, USD_DECIMALS, priceFormatDecimal, true)}`}
            ...
            <ExchangeInfoRow label={t`Fees`}>
              <div>
                ...
                {feesUsd && (
                  <Tooltip
                    handle={`$${formatAmount(feesUsd, USD_DECIMALS, priceFormatDecimal, true)}`}
                    position="right-bottom"
                    renderContent={() => {
                      return (
                        <div>
                          {swapFees && (
                            <div>
                              ...
                              <StatsTooltipRow
                                ...
                                value={formatAmount(swapFees, USD_DECIMALS, priceFormatDecimal, true)}
                              />
                              <br />
                            </div>
                          )}
                          <div>
                            <StatsTooltipRow
                              ...
                              value={formatAmount(positionFee, USD_DECIMALS, priceFormatDecimal, true)}
                            />
                          </div>
                        </div>
                      );
        ...
        {isStopOrder && (
          <div className="Exchange-swap-section Exchange-trigger-order-info">
            <Trans>
              ...
              <ExternalLink href="docs.liq.markets/trading#stop-loss-take-profit-orders">docs</ExternalLink>.
            </Trans>
          </div>
        )}
        ...
        <div className="Exchange-swap-market-box App-box App-box-border">
          ...
          <div className="Exchange-info-row">
            ...
            <div className="align-right">
              $
              {fromTokenInfo &&
                formatAmount(fromTokenInfo.minPrice, USD_DECIMALS, fromTokenInfo?.displayDecimals || 2, true)}
            </div>
          </div>
          <div className="Exchange-info-row">
            <div className="Exchange-info-label">
            ...
            <div className="align-right">
              $
              {toTokenInfo && formatAmount(toTokenInfo.maxPrice, USD_DECIMALS, toTokenInfo?.displayDecimals || 2, true)}
            </div>
          </div>
          <div className="Exchange-info-row">
            <div className="Exchange-info-label">
            ...
            <div className="align-right al-swap">
              <Tooltip
                handle={`$${formatAmount(maxSwapAmountUsd, USD_DECIMALS, priceFormatDecimal, true)}`}
                position="right-bottom"
                renderContent={() => {
                  return (
                    <div>
      ...
      {(isLong || isShort) && (
        <div className="Exchange-swap-market-box App-box App-box-border">
          ...
          <div className="Exchange-info-row">
            ...
            <div className="align-right">
              <Tooltip
                handle={`$${formatAmount(entryMarkPrice, USD_DECIMALS, toTokenInfo?.displayDecimals || 2, true)}`}
                position="right-bottom"
                renderContent={() => {
                  return (
                    <div>
                      <Trans>
                        ...
                        {formatAmount(entryMarkPrice, USD_DECIMALS, toTokenInfo?.displayDecimals || 2, true)} USD with a
                        ...
                        <br />
                        <br />
                        <ExternalLink href="docs.liq.markets/trading#opening-a-position">More Info</ExternalLink>
                      </Trans>
                    </div>
                  );
                }}
          ...
          <div className="Exchange-info-row">
            ...
            <div className="align-right">
              <Tooltip
                handle={`$${formatAmount(exitMarkPrice, USD_DECIMALS, toTokenInfo?.displayDecimals || 2, true)}`}
                position="right-bottom"
                renderContent={() => {
                  return (
                    <div>
                      <Trans>
                        ...
                        {formatAmount(entryMarkPrice, USD_DECIMALS, toTokenInfo?.displayDecimals || 2, true)} USD.
                        <br />
                        <br />
                ...
                renderContent={() => {
                  return (
                    <div>
                      ...
                      <br />
                      <ExternalLink href="docs.liq.markets/trading#opening-a-position">
          ...
          {isShort && toTokenInfo.hasMaxAvailableShort && (
            <div className="Exchange-info-row">
              ...
              <div className="align-right">
                <Tooltip
                  handle={`$${formatAmount(toTokenInfo.maxAvailableShort, USD_DECIMALS, priceFormatDecimal, true)}`}
                  position="right-bottom"
                  renderContent={() => {
                    return (
                      <>
                        <StatsTooltipRow
                          ...
                          value={formatAmount(toTokenInfo.maxGlobalShortSize, USD_DECIMALS, priceFormatDecimal, true)}
                        />
                        <StatsTooltipRow
                          label={t`Current ${toTokenInfo.symbol} shorts`}
                          value={formatAmount(toTokenInfo.globalShortSize, USD_DECIMALS, priceFormatDecimal, true)}
                        />
                      </>
                    );
                  }}
      ...
      <div className="Exchange-swap-market-box App-box App-box-border">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="docs.liq.markets/trading">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="docs.liq.markets/trading#backup-rpc-urls">
